...
public static class SeedData
{
    public static async Task Initialize(AppDbContext db)
    {
        ...
        {
            new() { Id = "b1",  VenueId = "v1", PlayerId = "u8",  Sport = "football",   Date = today.AddDays(-29), StartTime = "16:00", Duration = 2, Amount = 50,  TotalAmount = 50,  DepositAmount = 10,  DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(50),  OwnerAmount = own(50),  PaymentProof = "https://picsum.photos/seed/proof1/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b2",  VenueId = "v2", PlayerId = "u9",  Sport = "basketball",  Date = today.AddDays(-27), StartTime = "10:00", Duration = 1, Amount = 30,  TotalAmount = 30,  DepositAmount = 6,   DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(30),  OwnerAmount = own(30),  PaymentProof = "https://picsum.photos/seed/proof2/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b3",  VenueId = "v4", PlayerId = "u11", Sport = "padel",       Date = today.AddDays(-25), StartTime = "18:00", Duration = 1, Amount = 18,  TotalAmount = 18,  DepositAmount = 3.6, DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(18),  OwnerAmount = own(18),  PaymentProof = "https://picsum.photos/seed/proof3/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b4",  VenueId = "v1", PlayerId = "u12", Sport = "football",    Date = today.AddDays(-23), StartTime = "17:00", Duration = 2, Amount = 50,  TotalAmount = 50,  DepositAmount = 10,  DepositPaid = true,  PaymentMethod = "cliq", Status = "cancelled",       SystemFeePercentage = 5, SystemFee = fee(50),  OwnerAmount = own(50),  PaymentProof = "https://picsum.photos/seed/proof4/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b5",  VenueId = "v5", PlayerId = "u13", Sport = "volleyball",  Date = today.AddDays(-21), StartTime = "09:00", Duration = 2, Amount = 44,  TotalAmount = 44,  DepositAmount = 8.8, DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(44),  OwnerAmount = own(44),  PaymentProof = "https://picsum.photos/seed/proof5/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b6",  VenueId = "v7", PlayerId = "u14", Sport = "cricket",     Date = today.AddDays(-19), StartTime = "08:00", Duration = 4, Amount = 140, TotalAmount = 140, DepositAmount = 28,  DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(140), OwnerAmount = own(140), PaymentProof = "https://picsum.photos/seed/proof6/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b7",  VenueId = "v8", PlayerId = "u15", Sport = "swimming",    Date = today.AddDays(-18), StartTime = "08:00", Duration = 1, Amount = 40,  TotalAmount = 40,  DepositAmount = 8,   DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(40),  OwnerAmount = own(40),  PaymentProof = "https://picsum.photos/seed/proof7/600/400",  PaymentProofStatus = "approved" },
            new() { Id = "b8",  VenueId = "v2", PlayerId = "u8",  Sport = "volleyball",  Date = today.AddDays(-17), StartTime = "15:00", Duration = 2, Amount = 60,  TotalAmount = 60,  DepositAmount = 12,  DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(60),  OwnerAmount = own(60),  PaymentProof = "https://picsum.photos/seed/proof8/600/400",  PaymentProofStatus = "pending_review" },
            new() { Id = "b9",  VenueId = "v4", PlayerId = "u9",  Sport = "padel",       Date = today.AddDays(-15), StartTime = "19:00", Duration = 1, Amount = 18,  TotalAmount = 18,  DepositAmount = 3.6, DepositPaid = false, PaymentMethod = "cliq", Status = "pending_payment", SystemFeePercentage = 5, SystemFee = fee(18),  OwnerAmount = own(18) },
            new() { Id = "b10", VenueId = "v1", PlayerId = "u11", Sport = "football",    Date = today.AddDays(-14), StartTime = "16:00", Duration = 2, Amount = 50,  TotalAmount = 50,  DepositAmount = 10,  DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(50),  OwnerAmount = own(50),  PaymentProof = "https://picsum.photos/seed/proof10/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b11", VenueId = "v5", PlayerId = "u12", Sport = "football",    Date = today.AddDays(-13), StartTime = "10:00", Duration = 1, Amount = 22,  TotalAmount = 22,  DepositAmount = 4.4, DepositPaid = false, PaymentMethod = "cliq", Status = "pending_payment", SystemFeePercentage = 5, SystemFee = fee(22),  OwnerAmount = own(22),  PaymentProof = "https://picsum.photos/seed/proof11/600/400", PaymentProofStatus = "pending_review" },
            new() { Id = "b12", VenueId = "v7", PlayerId = "u13", Sport = "cricket",     Date = today.AddDays(-11), StartTime = "08:00", Duration = 3, Amount = 105, TotalAmount = 105, DepositAmount = 21,  DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(105), OwnerAmount = own(105), PaymentProof = "https://picsum.photos/seed/proof12/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b13", VenueId = "v8", PlayerId = "u14", Sport = "swimming",    Date = today.AddDays(-10), StartTime = "08:00", Duration = 2, Amount = 80,  TotalAmount = 80,  DepositAmount = 16,  DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(80),  OwnerAmount = own(80),  PaymentProof = "https://picsum.photos/seed/proof13/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b14", VenueId = "v2", PlayerId = "u15", Sport = "basketball",  Date = today.AddDays(-9),  StartTime = "17:00", Duration = 1, Amount = 30,  TotalAmount = 30,  DepositAmount = 6,   DepositPaid = true,  PaymentMethod = "cliq", Status = "cancelled",       SystemFeePercentage = 5, SystemFee = fee(30),  OwnerAmount = own(30),  PaymentProof = "https://picsum.photos/seed/proof14/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b15", VenueId = "v1", PlayerId = "u8",  Sport = "football",    Date = today.AddDays(-8),  StartTime = "18:00", Duration = 2, Amount = 50,  TotalAmount = 50,  DepositAmount = 10,  DepositPaid = false, PaymentMethod = "cliq", Status = "pending_payment", SystemFeePercentage = 5, SystemFee = fee(50),  OwnerAmount = own(50),  PaymentProof = "https://picsum.photos/seed/proof15/600/400", PaymentProofStatus = "pending_review" },
            new() { Id = "b16", VenueId = "v4", PlayerId = "u9",  Sport = "padel",       Date = today.AddDays(-7),  StartTime = "20:00", Duration = 1, Amount = 18,  TotalAmount = 18,  DepositAmount = 3.6, DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(18),  OwnerAmount = own(18),  PaymentProof = "https://picsum.photos/seed/proof16/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b17", VenueId = "v5", PlayerId = "u11", Sport = "volleyball",  Date = today.AddDays(-6),  StartTime = "09:00", Duration = 2, Amount = 44,  TotalAmount = 44,  DepositAmount = 8.8, DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(44),  OwnerAmount = own(44),  PaymentProof = "https://picsum.photos/seed/proof17/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b18", VenueId = "v7", PlayerId = "u12", Sport = "cricket",     Date = today.AddDays(-5),  StartTime = "08:00", Duration = 4, Amount = 140, TotalAmount = 140, DepositAmount = 28,  DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(140), OwnerAmount = own(140), PaymentProof = "https://picsum.photos/seed/proof18/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b19", VenueId = "v8", PlayerId = "u13", Sport = "swimming",    Date = today.AddDays(-4),  StartTime = "08:00", Duration = 1, Amount = 40,  TotalAmount = 40,  DepositAmount = 8,   DepositPaid = false, PaymentMethod = "cliq", Status = "pending_payment", SystemFeePercentage = 5, SystemFee = fee(40),  OwnerAmount = own(40) },
            new() { Id = "b20", VenueId = "v2", PlayerId = "u14", Sport = "basketball",  Date = today.AddDays(-3),  StartTime = "14:00", Duration = 2, Amount = 60,  TotalAmount = 60,  DepositAmount = 12,  DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(60),  OwnerAmount = own(60),  PaymentProof = "https://picsum.photos/seed/proof20/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b21", VenueId = "v1", PlayerId = "u15", Sport = "football",    Date = today.AddDays(-2),  StartTime = "16:00", Duration = 1, Amount = 25,  TotalAmount = 25,  DepositAmount = 5,   DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(25),  OwnerAmount = own(25),  PaymentProof = "https://picsum.photos/seed/proof21/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b22", VenueId = "v4", PlayerId = "u8",  Sport = "padel",       Date = today.AddDays(-2),  StartTime = "19:00", Duration = 2, Amount = 36,  TotalAmount = 36,  DepositAmount = 7.2, DepositPaid = true,  PaymentMethod = "cliq", Status = "completed",       SystemFeePercentage = 5, SystemFee = fee(36),  OwnerAmount = own(36),  PaymentProof = "https://picsum.photos/seed/proof22/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b23", VenueId = "v5", PlayerId = "u9",  Sport = "football",    Date = today.AddDays(-1),  StartTime = "10:00", Duration = 1, Amount = 22,  TotalAmount = 22,  DepositAmount = 4.4, DepositPaid = false, PaymentMethod = "cliq", Status = "pending_payment", SystemFeePercentage = 5, SystemFee = fee(22),  OwnerAmount = own(22),  PaymentProof = "https://picsum.photos/seed/proof23/600/400", PaymentProofStatus = "pending_review" },
            new() { Id = "b24", VenueId = "v7", PlayerId = "u11", Sport = "cricket",     Date = today.AddDays(-1),  StartTime = "08:00", Duration = 3, Amount = 105, TotalAmount = 105, DepositAmount = 21,  DepositPaid = true,  PaymentMethod = "cliq", Status = "confirmed",       SystemFeePercentage = 5, SystemFee = fee(105), OwnerAmount = own(105), PaymentProof = "https://picsum.photos/seed/proof24/600/400", PaymentProofStatus = "approved" },
            new() { Id = "b25", VenueId = "v8", PlayerId = "u12", Sport = "swimming",    Date = today,              StartTime = "08:00", Duration = 1, Amount = 40,  TotalAmount = 40,  DepositAmount = 8,   DepositPaid = false, PaymentMethod = "cliq", Status = "pending_payment", SystemFeePercentage = 5, SystemFee = fee(40),  OwnerAmount = own(40) },
        };
